...
export const TEAMS: Team[] = [
  // Group A
  { name: 'Mexico', code: 'MEX', flag: '🇲🇽', tier: 3, group: 'A' },
  { name: 'South Africa', code: 'RSA', flag: '🇿🇦', tier: 5, group: 'A' },
  { name: 'South Korea', code: 'KOR', flag: '🇰🇷', tier: 3, group: 'A' },
  { name: 'Czechia', code: 'CZE', flag: '🇨🇿', tier: 4, group: 'A' },
  // Group B
  { name: 'Canada', code: 'CAN', flag: '🇨🇦', tier: 4, group: 'B' },
  { name: 'Bosnia & Herzegovina', code: 'BIH', flag: '🇧🇦', tier: 5, group: 'B' },
  { name: 'Qatar', code: 'QAT', flag: '🇶🇦', tier: 5, group: 'B' },
  { name: 'Switzerland', code: 'SUI', flag: '🇨🇭', tier: 3, group: 'B' },
  // Group C
  { name: 'Brazil', code: 'BRA', flag: '🇧🇷', tier: 1, group: 'C' },
  { name: 'Morocco', code: 'MAR', flag: '🇲🇦', tier: 2, group: 'C' },
  { name: 'Haiti', code: 'HAI', flag: '🇭🇹', tier: 5, group: 'C' },
  { name: 'Scotland', code: 'SCO', flag: '🏴󠁧󠁢󠁳󠁣󠁴󠁿', tier: 4, group: 'C' },
  // Group D
  { name: 'United States', code: 'USA', flag: '🇺🇸', tier: 3, group: 'D' },
  { name: 'Paraguay', code: 'PAR', flag: '🇵🇾', tier: 4, group: 'D' },
  { name: 'Australia', code: 'AUS', flag: '🇦🇺', tier: 4, group: 'D' },
  { name: 'Türkiye', code: 'TUR', flag: '🇹🇷', tier: 3, group: 'D' },
  // Group E
  { name: 'Germany', code: 'GER', flag: '🇩🇪', tier: 1, group: 'E' },
  { name: 'Curaçao', code: 'CUW', flag: '🇨🇼', tier: 5, group: 'E' },
  { name: 'Ivory Coast', code: 'CIV', flag: '🇨🇮', tier: 3, group: 'E' },
  { name: 'Ecuador', code: 'ECU', flag: '🇪🇨', tier: 3, group: 'E' },
  // Group F
  { name: 'Netherlands', code: 'NED', flag: '🇳🇱', tier: 1, group: 'F' },
  { name: 'Japan', code: 'JPN', flag: '🇯🇵', tier: 2, group: 'F' },
  { name: 'Sweden', code: 'SWE', flag: '🇸🇪', tier: 4, group: 'F' },
  { name: 'Tunisia', code: 'TUN', flag: '🇹🇳', tier: 4, group: 'F' },
  // Group G
  { name: 'Belgium', code: 'BEL', flag: '🇧🇪', tier: 2, group: 'G' },
  { name: 'Egypt', code: 'EGY', flag: '🇪🇬', tier: 3, group: 'G' },
  { name: 'Iran', code: 'IRN', flag: '🇮🇷', tier: 3, group: 'G' },
  { name: 'New Zealand', code: 'NZL', flag: '🇳🇿', tier: 5, group: 'G' },
  // Group H
  { name: 'Spain', code: 'ESP', flag: '🇪🇸', tier: 1, group: 'H' },
  { name: 'Cape Verde', code: 'CPV', flag: '🇨🇻', tier: 5, group: 'H' },
  { name: 'Saudi Arabia', code: 'KSA', flag: '🇸🇦', tier: 5, group: 'H' },
  { name: 'Uruguay', code: 'URU', flag: '🇺🇾', tier: 2, group: 'H' },
  // Group I
  { name: 'France', code: 'FRA', flag: '🇫🇷', tier: 1, group: 'I' },
  { name: 'Senegal', code: 'SEN', flag: '🇸🇳', tier: 2, group: 'I' },
  { name: 'Iraq', code: 'IRQ', flag: '🇮🇶', tier: 5, group: 'I' },
  { name: 'Norway', code: 'NOR', flag: '🇳🇴', tier: 3, group: 'I' },
  // Group J
  { name: 'Argentina', code: 'ARG', flag: '🇦🇷', tier: 1, group: 'J' },
  { name: 'Algeria', code: 'ALG', flag: '🇩🇿', tier: 4, group: 'J' },
  { name: 'Austria', code: 'AUT', flag: '🇦🇹', tier: 3, group: 'J' },
  { name: 'Jordan', code: 'JOR', flag: '🇯🇴', tier: 5, group: 'J' },
  // Group K
  { name: 'Portugal', code: 'POR', flag: '🇵🇹', tier: 1, group: 'K' },
  { name: 'DR Congo', code: 'COD', flag: '🇨🇩', tier: 4, group: 'K' },
  { name: 'Uzbekistan', code: 'UZB', flag: '🇺🇿', tier: 5, group: 'K' },
  { name: 'Colombia', code: 'COL', flag: '🇨🇴', tier: 2, group: 'K' },
  // Group L
  { name: 'England', code: 'ENG', flag: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', tier: 1, group: 'L' },
  { name: 'Croatia', code: 'CRO', flag: '🇭🇷', tier: 2, group: 'L' },
  { name: 'Ghana', code: 'GHA', flag: '🇬🇭', tier: 4, group: 'L' },
  { name: 'Panama', code: 'PAN', flag: '🇵🇦', tier: 5, group: 'L' },
];
