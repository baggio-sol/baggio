...
function Step1({ localName, setLocalName, shook }: {
  ...
  return (
    <div className="flex flex-col items-center text-center">
        ...
        >
          ...
          <input
            ...
            style={{
              ...
              border: `1.5px solid ${localName.trim() ? '#7c3aed' : 'rgba(0,0,0,0.15)'}`,
              color: '#111827',
            }}
          />
        </div>
        {localName.trim() ? (
          <p className="text-xs mt-2 text-left font-medium" style={{ color: '#7c3aed' }}>
      ...
      >
        <span className="font-display font-extrabold" style={{ fontSize: 'clamp(1.8rem,4vw,2.4rem)', color: '#7c3aed' }}>
          449 points
        </span>
    ...
    <div className="flex flex-col items-center text-center">
      ...
      >
        <p className="text-sm font-semibold" style={{ color: '#374151' }}>
          Hit <span style={{ color: '#7c3aed' }}>&quot;Create my bracket&quot;</span> below to start — it takes about 15 minutes.
        </p>
      </div>
    </div>
  );
