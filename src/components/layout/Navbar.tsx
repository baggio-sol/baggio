                ...
                {userMenuOpen && (
                  ...
                  >
                    ...
                    <button
                      ...
                      style={{ color: '#c4bdec', borderColor: 'rgba(255,255,255,0.08)' }}
                    >
        ...
        >
          <div className="px-4 py-3 space-y-1">
            ...
            {user ? (
              <button
                onClick={handleSignOut}
                className="flex items-center gap-2 w-full px-4 py-3 rounded-xl text-sm font-medium transition-all text-[#c4bdec] hover:text-white hover:bg-white/10"
              >
                <LogOut className="w-4 h-4" /> Sign out
              </button>
            ) : (
