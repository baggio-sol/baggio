        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            <button
              ...
              style={{
                background: theme === 'dark' ? 'linear-gradient(135deg,#7c3aed,#2563eb)' : 'rgba(255,255,255,0.06)',
                color: theme === 'dark' ? '#fff' : '#a09db8',
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all"
              style={{
                background: theme === 'light' ? 'linear-gradient(135deg,#7c3aed,#2563eb)' : 'rgba(255,255,255,0.06)',
                color: theme === 'light' ? '#fff' : '#a09db8',
          ...
          >
            {imgUrl ? (
              ...
              <div className="flex flex-col items-center gap-2" style={{ color: '#a09db8' }}>
            ...
            {rendering && imgUrl && (
              <div className="absolute top-2 right-2 rounded-full px-2 py-1 flex items-center gap-1" style={{ background: 'rgba(0,0,0,0.5)' }}>
                <Loader2 className="w-3 h-3 animate-spin" style={{ color: '#9d7fea' }} />
                <span className="text-[10px] font-bold" style={{ color: '#9d7fea' }}>updating</span>
              </div>
            )}
          </div>
          <p className="text-center text-[11px] font-bold tracking-widest uppercase mb-5" style={{ color: '#a09db8' }}>
          ...
          >
            <div className="flex-1 min-w-0">
              <p className="text-[10px] font-bold uppercase tracking-widest mb-0.5" style={{ color: '#a09db8' }}>
                Name on ticket
              </p>
              {editingName ? (
                <input
          ...
          <p className="text-[11px] leading-relaxed mt-4 flex items-start gap-1.5" style={{ color: '#a09db8' }}>
            <Trophy className="w-3.5 h-3.5 flex-shrink-0 mt-0.5" style={{ color: '#a09db8' }} />
